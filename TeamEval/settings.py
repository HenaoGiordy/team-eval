"""
Django settings for TeamEval project.
...
WSGI_APPLICATION = 'TeamEval.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'giordy.henao@correounivalle.edu.co'
EMAIL_HOST_PASSWORD = 'qnrc aecr hzby vtcr '
