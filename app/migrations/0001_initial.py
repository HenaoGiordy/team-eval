# Generated by Django 5.0.3 on 2024-05-19 03:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.IntegerField(error_messages={'blank': 'Este campo no puede estar vacío.', 'unique': 'Ya existe un usuario con ese código'}, help_text='El código de usuario es único y de debe ser un valor numérico.', unique=True, verbose_name='Codigo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('curso', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.curso')),
                ('estudiante_evaluado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='evaluado', to='app.perfilestudiante')),
                ('estudiante_evaluador', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='evaluador', to='app.perfilestudiante')),
                ('rubrica', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='app.rubrica')),
            ],
        ),
        migrations.AddField(
            model_name='criterio',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rubrica', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.rubrica')),
            ],
        ),
