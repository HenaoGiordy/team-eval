# Generated by Django 5.0.3 on 2024-05-24 01:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('curso', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.curso')),
                ('evaluadores', models.ManyToManyField(related_name='evaluaciones_hechas', to='app.perfilestudiante')),
                ('evaluados', models.ManyToManyField(related_name='evaluaciones_recibidas', to='app.perfilestudiante')),
