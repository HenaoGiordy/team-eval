...
urlpatterns= [
    ...
    path('estudiante/configuracion', views.estudiante_configuracion, name="estudiante_configuracion"),
    ...
    path('profesor/configuracion', views.profesor_configuracion, name="profesor_configuracion"),    
    ...
    path('administrador/configuracion', views.administrador_configuracion, name="administrador_configuracion"),
