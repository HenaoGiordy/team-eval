...
urlpatterns= [
    ...
    path('estudiante/evaluar/<int:evaluacionid>/<int:grupoid>', views.evaluar, name="evaluar"),
    path('estudiante/retroalimentacion', views.estudiante_retroalimentacion, name="estudiante_retroalimentacion"),
    path('estudiante/retroalimentacion/ver_resultado/<int:evaluacionid>', views.estudiante_ver_resultado, name="estudiante_ver_resultado"),
    ...
    path('profesor/ver_informes_curso', views.ver_informe_curso, name="ver_informe_curso"),    
