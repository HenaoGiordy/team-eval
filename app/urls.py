...
urlpatterns= [
    ...
    path('login/recuperar_contraseña', views.login_recuperar_contraseña, name="login_recuperar_contraseña"),
    ...
    path('profesor/curso', views.profesor_curso, name="profesor_curso"),
    path('profesor/estudiantes_curso', views.profesor_estudiantes_curso, name="profesor_estudiantes_curso"),
